...
jieba.set_dictionary('/home/cloudera/Desktop/text_mining/dict.txt') #結巴預設詞庫
jieba.load_userdict("/home/cloudera/Desktop/text_mining/dict_keyw_new.txt") #抽出新聞關鍵詞組成的詞庫
conf = (SparkConf().set("spark.driver.maxResultSize", "4g"))
sc = pyspark.SparkContext(master="local[*]", conf=conf, appName="kmeans")
#km = KMeansModel.load(sc, "file:/home/cloudera/Desktop/text_mining/KMeansModel_zzu_0") #loading trained model
